...
# Ce fichier est dans src/oceens/core/ : la racine du dépôt est trois dossiers
# au-dessus. Installé hors d'un clone (image Docker), le package ne peut pas la
# connaître : LOCAL_DATABASE_DIR y est alors défini.
