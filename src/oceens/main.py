...
def _maybe_start_summaries_daemon():
    ...
    # sys.executable = le même interpréteur Python que celui d'uvicorn ; le
    # daemon est lancé par son nom de module, pas par un chemin relatif au
    # répertoire courant.
    return subprocess.Popen([sys.executable, "-m", "oceens.summaries_generator_daemon"])
